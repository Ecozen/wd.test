...
private void getWorkBook(){
  ...
  @BeforeTest
  @Parameters({"sheetName","workBook","serviceUrl","testEnv"})
  public void beforeTest(String sheetName,String path,String serviceUrl,String testEnv) throws MalformedURLException {
      filePath = path;
      getWorkBook();
